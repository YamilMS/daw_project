...
, we take your privacy seriously and are committed to protecting your personal information. This Privacy Policy explains how we collect, use, and disclose your personal information when you visit our website or use our services. By using our services, you agree to the practices described in this Privacy Policy.
  ...
  <p>
    By using and accessing any of the Services, you agree to the collection, use, and disclosure of your information as described in this Privacy Policy. If you do not agree to this Privacy Policy, please do not use or access any of the Services. We may update this Privacy Policy from time to time to reflect changes in our practices or for operational, legal, or regulatory reasons. The revised Privacy Policy will be posted on the Site with the "Last updated" date changed accordingly.
  </p>
  ...
  <ul>
    ...
    <li>Our payment processors, who collect payment information (e.g., bank account, credit or debit card information, billing address) to process your payment in order to fulfill your orders and provide you with products or services you have requested, to perform our contract with you.</li>
  ...
  <ul>
    <li>Right to access: You have the right to request information about how we process your personal information and to obtain a copy of that personal information.</li>
    <li>Right to rectification: You have the right to request the correction of inaccurate personal information and to have incomplete personal information completed.</li>
    <li>Right to erasure: You have the right to request that we erase your personal information, subject to certain exceptions.</li>
    <li>Right to restrict processing: You have the right to request that we restrict the processing of your personal information, subject to certain exceptions.</li>
    <li>Right to data portability: You have the right to request that we transmit your personal information to another service provider or third party, where technically feasible.</li>
    <li>Right to object: You have the right to object to our processing of your personal information, subject to certain exceptions.</li>
    <li>Right to withdraw consent: If we rely on your consent to process your personal information, you have the right to withdraw your consent at any time.</li>
